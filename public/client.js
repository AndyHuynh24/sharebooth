...
const LAYOUTS = {
  '2cut': {
    aspectRatio: 2 / 3,
    slots: [
      { x: 0.05, y: 0.10, w: 0.90, h: 0.42 },
      { x: 0.05, y: 0.53, w: 0.90, h: 0.42 },
    ]
  },
  'strip3': {
    aspectRatio: 1 / 2.5,
    slots: [
      { x: 0.05, y: 0.09, w: 0.90, h: 0.28 },
      { x: 0.05, y: 0.38, w: 0.90, h: 0.28 },
      { x: 0.05, y: 0.67, w: 0.90, h: 0.28 },
    ]
  },
  'strip': {
    aspectRatio: 1 / 3,
    slots: [
      { x: 0.05, y: 0.08, w: 0.90, h: 0.21 },
      { x: 0.05, y: 0.30, w: 0.90, h: 0.21 },
      { x: 0.05, y: 0.52, w: 0.90, h: 0.21 },
  ...
  '2x2': {
    aspectRatio: 3 / 4,
    slots: [
      { x: 0.05, y: 0.10, w: 0.44, h: 0.42 },
      { x: 0.51, y: 0.10, w: 0.44, h: 0.42 },
      { x: 0.05, y: 0.53, w: 0.44, h: 0.42 },
      { x: 0.51, y: 0.53, w: 0.44, h: 0.42 },
    ]
  },
  '6cut': {
    aspectRatio: 2 / 3,
    slots: [
      { x: 0.05, y: 0.09, w: 0.44, h: 0.28 },
      { x: 0.51, y: 0.09, w: 0.44, h: 0.28 },
      { x: 0.05, y: 0.38, w: 0.44, h: 0.28 },
      { x: 0.51, y: 0.38, w: 0.44, h: 0.28 },
      { x: 0.05, y: 0.67, w: 0.44, h: 0.28 },
      { x: 0.51, y: 0.67, w: 0.44, h: 0.28 },
    ]
  },
  '1big3': {
    aspectRatio: 4 / 3,
    slots: [
      { x: 0.05, y: 0.10, w: 0.54, h: 0.83 },
      { x: 0.61, y: 0.10, w: 0.34, h: 0.27 },
      { x: 0.61, y: 0.39, w: 0.34, h: 0.27 },
      { x: 0.61, y: 0.68, w: 0.34, h: 0.27 },
    ]
  },
  'freeform': {
    aspectRatio: 1,
