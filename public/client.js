...
const LAYOUTS = {
  '2cut': {
    aspectRatio: 2 / 3,
    slots: [
      { x: 0.05, y: 0.08, w: 0.90, h: 0.44 },
      { x: 0.05, y: 0.53, w: 0.90, h: 0.44 },
    ]
  },
  'strip3': {
    aspectRatio: 1 / 2.5,
    slots: [
      { x: 0.05, y: 0.07, w: 0.90, h: 0.29 },
      { x: 0.05, y: 0.37, w: 0.90, h: 0.29 },
  ...
  'strip': {
    aspectRatio: 1 / 3,
    slots: [
      { x: 0.05, y: 0.06, w: 0.90, h: 0.22 },
      { x: 0.05, y: 0.29, w: 0.90, h: 0.22 },
      { x: 0.05, y: 0.52, w: 0.90, h: 0.22 },
      { x: 0.05, y: 0.75, w: 0.90, h: 0.22 },
    ]
  },
  '2x2': {
    aspectRatio: 3 / 4,
    slots: [
      { x: 0.05, y: 0.08, w: 0.44, h: 0.44 },
      { x: 0.51, y: 0.08, w: 0.44, h: 0.44 },
      { x: 0.05, y: 0.53, w: 0.44, h: 0.44 },
      { x: 0.51, y: 0.53, w: 0.44, h: 0.44 },
    ]
  },
  '6cut': {
    aspectRatio: 2 / 3,
    slots: [
      { x: 0.05, y: 0.07, w: 0.44, h: 0.29 },
      { x: 0.51, y: 0.07, w: 0.44, h: 0.29 },
      { x: 0.05, y: 0.37, w: 0.44, h: 0.29 },
      { x: 0.51, y: 0.37, w: 0.44, h: 0.29 },
      { x: 0.05, y: 0.67, w: 0.44, h: 0.29 },
      { x: 0.51, y: 0.67, w: 0.44, h: 0.29 },
    ]
  },
  '1big3': {
    aspectRatio: 4 / 3,
    slots: [
      { x: 0.05, y: 0.08, w: 0.55, h: 0.84 },
      { x: 0.61, y: 0.08, w: 0.34, h: 0.28 },
      { x: 0.61, y: 0.37, w: 0.34, h: 0.28 },
      { x: 0.61, y: 0.68, w: 0.34, h: 0.28 },
    ]
  },
  'freeform': {
    aspectRatio: 1,
