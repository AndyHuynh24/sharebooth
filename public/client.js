...
// edge padding = 0.05, gap between photos = 0.01, top = 0.10, bottom margin visible
const LAYOUTS = {
  '2cut': {
    aspectRatio: 2 / 3,
    slots: [
      { x: 0.05, y: 0.10, w: 0.90, h: 0.43 },
      { x: 0.05, y: 0.53, w: 0.90, h: 0.43 },
    ]
  },
  'strip3': {
    aspectRatio: 1 / 2.5,
    slots: [
      { x: 0.05, y: 0.09, w: 0.90, h: 0.29 },
      { x: 0.05, y: 0.38, w: 0.90, h: 0.29 },
      { x: 0.05, y: 0.67, w: 0.90, h: 0.29 },
    ]
  },
  'strip': {
    aspectRatio: 1 / 3,
    slots: [
      { x: 0.05, y: 0.08, w: 0.90, h: 0.215 },
      { x: 0.05, y: 0.30, w: 0.90, h: 0.215 },
      { x: 0.05, y: 0.52, w: 0.90, h: 0.215 },
      { x: 0.05, y: 0.74, w: 0.90, h: 0.215 },
    ]
  },
  '2x2': {
    aspectRatio: 3 / 4,
    slots: [
      { x: 0.05, y: 0.10, w: 0.445, h: 0.43 },
      { x: 0.505, y: 0.10, w: 0.445, h: 0.43 },
      { x: 0.05, y: 0.53, w: 0.445, h: 0.43 },
      { x: 0.505, y: 0.53, w: 0.445, h: 0.43 },
    ]
  },
  '6cut': {
    aspectRatio: 2 / 3,
    slots: [
      { x: 0.05, y: 0.09, w: 0.445, h: 0.29 },
      { x: 0.505, y: 0.09, w: 0.445, h: 0.29 },
      { x: 0.05, y: 0.38, w: 0.445, h: 0.29 },
      { x: 0.505, y: 0.38, w: 0.445, h: 0.29 },
      { x: 0.05, y: 0.67, w: 0.445, h: 0.29 },
      { x: 0.505, y: 0.67, w: 0.445, h: 0.29 },
    ]
  },
  '1big3': {
    aspectRatio: 4 / 3,
    slots: [
      { x: 0.05, y: 0.10, w: 0.55, h: 0.84 },
      { x: 0.61, y: 0.10, w: 0.34, h: 0.275 },
      { x: 0.61, y: 0.39, w: 0.34, h: 0.275 },
      { x: 0.61, y: 0.68, w: 0.34, h: 0.275 },
    ]
  },
  'freeform': {
    aspectRatio: 1,
